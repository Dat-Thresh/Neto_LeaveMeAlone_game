...
#include "LevelActors/Damage/LMA_DamageActor.h"


// Sets default values
ALMA_DamageActor::ALMA_DamageActor()
{
...
void ALMA_DamageActor::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ALMA_DamageActor::Tick(float DeltaTime)
{
